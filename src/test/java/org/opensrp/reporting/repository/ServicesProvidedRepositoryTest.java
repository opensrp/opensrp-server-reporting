...
public class ServicesProvidedRepositoryTest {
	...
	public void setUp() throws Exception {
		initMocks(this);
		repository = new ServicesProvidedRepository(indicatorRepository, locationRepository, serviceProvidersRepository,
		        servicesProvidedRepository, monitor);
	}
	...
	public void shouldUpdateListOfServiceProvidedIndicatorRowsForReportingMonthForAllANMs() throws Exception {
		...
		ReportDataUpdateRequest request = new ReportDataUpdateRequest().withType("type").withIndicator(indicator)
		        .withStartDate(startDate).withEndDate(endDate).withReportingData(asList(reportingData));
