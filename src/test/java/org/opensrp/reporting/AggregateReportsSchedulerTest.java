	...
	private RepeatingSchedulableJob verifyJob() {
		return Matchers.argThat(new ArgumentMatcher<RepeatingSchedulableJob>() {
			...
			public boolean matches(Object o) {
				...
				return LocalDateTime.parse("2013-01-01T12:00:00.000").plusMinutes(10).toDate().equals(job.getStartTime())
				        && DateTimeConstants.MILLIS_PER_MINUTE * REPEAT_INTERVAL_IN_MINUTES == job
