...
import static org.opensrp.common.domain.Indicator.BCG;
import static org.opensrp.common.domain.Indicator.FP_CONDOM;
import static org.opensrp.common.domain.Indicator.FP_IUD;
...
public class ReportDataControllerTest {
	...
	public void shouldUpdateListOfServiceProvidedIndicatorRowsForReportingMonthForAllANMs() throws Exception {
		...
		ReportDataUpdateRequest reportDataUpdateRequest = new ReportDataUpdateRequest().withType(type)
	...
	public void shouldDeleteAllServiceProvidedReportsGivenAnEntityID() throws Exception {
		ReportDataDeleteRequest deleteRequest = new ReportDataDeleteRequest().withType("serviceProvided")
	...
	public void shouldDeleteAllANMReportsGivenAnEntityID() throws Exception {
		ReportDataDeleteRequest deleteRequest = new ReportDataDeleteRequest().withType("anmReportData")
		        .withDristhiEntityId("entity id 1");
	...
	public void shouldDeleteListOfANMReportsIndicatorRowsForReportingMonthForAllANMs() throws Exception {
		...
		ReportDataUpdateRequest reportDataUpdateRequest = new ReportDataUpdateRequest().withType("anmReportData")
		        .withReportingData(asList(reportingData)).withStartDate(startDate).withEndDate(endDate)
